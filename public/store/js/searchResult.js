...
//	localStorage.removeItem('cart');
    ...
    if(parts.length>1){
	       ...
	       if (id[0]=='query') {
					       ...
					       $.ajax({   
					           async: true,  
					           url: baseurl + 'getItemsByFilter/'+id[1]+'/'+business_id.business_id,
					           method: "GET",   
					           headers: {  
						        	     ...
						        	     $(products).each(function( index, value ) {
						        		      ...
						        		      if(index < 10){
						        		    	  ...
						        		    	  htmlTopSelling = htmlTopSelling + '<div class="product">'
						        		            +'<a href="product.html?product='+value.item_id+'"><article> <img class="img-responsive" src="'+imageURL+'/'+itemImage+'" alt="">' 
